      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2">
            {showBackButton && (
              <button
                onClick={goBack}
                title={t('Back', 'पीछे')}
                className="flex items-center space-x-1 bg-[#0F3E22] hover:bg-[#1E6B3C] text-emerald-100 text-xs font-bold px-2.5 py-2 rounded-xl border border-emerald-500/30 transition-colors"
              >
            ...
            {/* Clicking the logo always takes you all the way back to the
                public landing / role-selector screen — a full "home", as
                distinct from the "← Back" button's one-step-back history. */}
            <div
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            {/* Language Switcher — full dropdown across all 8 supported languages */}
            <div className="relative">
              ...
              {isLangOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-44 bg-white rounded-xl shadow-xl border border-gray-200 py-1.5 z-50 max-h-80 overflow-y-auto">
